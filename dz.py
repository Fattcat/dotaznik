...
a = input(f"Napíš svoje meno a priezvisko : ")
b = input(f"Napíš svoju adresu : ")
c = input(f"Tvoje telefone číslo : ")
d = input(f"rodne číslo : ")
e = input(f"číslo MAMINY : ")
f = input(f"číslo OTCA : ")
f = input(f"E-mail : ")
...
print(f"{orange}Cislo Otca : {reset}")
